...
public class EmployeController {
	...
	@RequestMapping(value = "", method = RequestMethod.GET, produces = APPLICATION_JSON_CHARSET_UTF_8, params = "matricule")
	...
	public Page<Employe> afficheListeEmployes(@RequestParam("page") Integer page, @RequestParam("size") Integer size,
	...
	@RequestMapping(value = "", method = RequestMethod.POST, consumes = APPLICATION_JSON_CHARSET_UTF_8, produces = APPLICATION_JSON_CHARSET_UTF_8)
